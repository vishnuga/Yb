...
<div class="nav-side-menu">
    ...
    <i class="fa fa-bars fa-2x toggle-btn" data-toggle="collapse" data-target="#menu-content"></i>
        ...
        <div class="menu-list">
            ...
            <ul id="menu-content" class="menu-content collapse out">
                ...
                <li class="">
                  <a href="http://127.0.0.1:8000/admin"><i class="fa fa-dashboard fa-lg"></i>Dashboard</span></a>
                </li>
                <li class="collapsed ">
                  <a href="academic"><i class="fa fa-gift fa-lg"></i>Academic</a>
                </li>
 ...
 <div id="page-wrapper">
   ...
   <table class="table table-responsive table-hover" id="student-table">
	<thead>
	<tr> 
		<th>First Name</th> 
		<th>Last Name</th> 
    ...
    <th>Level</th>
    <th>Select Level</th>
	 	<th>Action<span class="pull-right"><a href="http://192.248.56.20/match-module/students/change-level" class="btn-aja"> <i class="fa fa-users"></i> Level Students</a></span></th>
...
$(document).ready(function(){
   var table= $('#student-table').DataTable({
        ...
        columns: [
            ...
            {data: 'select_level', name: 'select_level',orderable:false,searchable:false},
          ...
          $('.levelSelectbox').change(function(){
                    ...
                    get.done(function(data){
                        if(data.success){
                            ...
                            swal({
                                title: "Please choose valid level!.",
                                timer: 2000,
                                type:"error",
                                showConfirmButton: false
                            });
